...
MSGS = {
    ...
    'hot_tr_cache_out': ('Cache out', ),
    'hot_tr_cache_in': ('Cache in', ),
    'hot_tr_empty': ('empty', ),
    # hot transaction acc.sets
#   'hot_tr_set_service': ('00', '00', ),
#   'hot_tr_set_shipping': ('62', '46', ),
#   'hot_tr_set_mat_to_prod': ('20', '05', ),
#   'hot_tr_set_get_invoice': ('80', '62', ),
#   'hot_tr_set_make_invoice': ('62', '80', ),
#   'hot_tr_set_from_bank': ('62', '51', ),
#   'hot_tr_set_to_bank': ('51', '62', ),
#   'hot_tr_set_to_stock': ('41', '20', ),
#   'hot_tr_set_consumable_purchase': ('06', '62', ),
#   'hot_tr_set_mat_purchase': ('05', '62', ),
#   'hot_tr_set_pay_salary': ('71', '50/1', ),
#   'hot_tr_set_calc_salary': ('80', '71', ),
#   'hot_tr_set_accountable_cache_out': ('72/1', '50/1', ),
#   'hot_tr_set_accountable_cache_return': ('50/1', '72/1', ),
#   'hot_tr_set_accountable_cache_spent': ('62', '72/1', ),
#   'hot_tr_set_cache_out': ('62', '50/1', ),
#   'hot_tr_set_cache_in': ('50/1', '62', ),
#   'hot_tr_set_empty': ('', '', ),
    # tab titles
